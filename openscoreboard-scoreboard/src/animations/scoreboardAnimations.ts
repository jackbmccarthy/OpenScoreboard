...
const viewTriggerFieldGroups: Record<string, string[]> = {
    ...
    'player-name-fields': [
        ...
        'playerA2',
        'playerB2',
        'playerAFirstInitialLastName',
        'playerBFirstInitialLastName',
        'playerA2FirstInitialLastName',
        'playerB2FirstInitialLastName',
        'playerAFirstNameLastInitial',
        'playerBFirstNameLastInitial',
        'playerA2FirstNameLastInitial',
        'playerB2FirstNameLastInitial',
        'playerANameWithRating',
        'playerBNameWithRating',
        'playerA2NameWithRating',
        'playerB2NameWithRating',
        'combinedAName',
        'combinedBName',
        'combinedAFirstInitialLastName',
        'combinedBFirstInitialLastName',
        'combinedAFirstNameLastInitial',
        'combinedBFirstNameLastInitial',
        'combinedANameWithRating',
        'combinedBNameWithRating',
        'courtSideCombinedAName',
        'courtSideCombinedBName',
        'courtSideCombinedAFirstInitialLastName',
        'courtSideCombinedBFirstInitialLastName',
        'courtSideCombinedAFirstNameLastInitial',
        'courtSideCombinedBFirstNameLastInitial',
        'courtSideCombinedANameWithRating',
        'courtSideCombinedBNameWithRating',
    ],
