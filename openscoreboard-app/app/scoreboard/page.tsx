                ...
                <VStack space="sm">
                  ...
                  <HStack space="sm">
                    <Button 
                      size="sm" 
                      variant="outline"
                      onPress={() => window.open('/scoreboard/dist/index.html', '_blank')}
                    >
                    ...
                    <Button 
                      size="sm" 
                      variant="outline"
                      onPress={() => window.open('http://localhost:3002', '_blank')}
                    >
...
function ScoreboardItem({ name, description, port }: { name: string; description: string; port: number }) {
  return (
    <Pressable className="p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
      <HStack className="justify-between items-center">
        ...
        <HStack space="xs">
          <Button size="xs" variant="ghost" onPress={() => window.open(`http://localhost:${port}`, '_blank')}>
            <Text>Dev</Text>
          </Button>
          <Button size="xs" variant="ghost" onPress={() => window.open(`/scoreboard/dist/index.html`, '_blank')}>
...
function ExternalLinkIcon({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
