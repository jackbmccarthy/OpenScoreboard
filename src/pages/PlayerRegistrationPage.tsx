...
export default function PlayerRegistrationPage() {
  const params = useParams<{ playerListID?: string; password?: string }>();
  ...
  useEffect(() => {
    async function checkPlayerList() {
      try {
        ...
        if (params.playerListID) {
          const unSub = watchForPlayerListPasswordChange(params.playerListID, (password: string) => {
          ...
          const playerList = await getPlayerListName(params.playerListID);
    ...
    checkPlayerList();
  }, [params.playerListID, params.password]);
